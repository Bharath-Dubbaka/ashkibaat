        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 pr-10">
            ...
            <Link href="/" className="flex items-center space-x-1 ">
              ...
              >
                <defs>
                  <linearGradient
                    ...
                    y2="100%"
                  >
                    <stop offset="10%" stopColor="#FFD700" /> {/* Yellow */}
                    <stop offset="30%" stopColor="#FF8C00" /> {/* Orange */}
                    <stop offset="75%" stopColor="#1E90FF" /> {/* Blue */}
                  </linearGradient>
              ...
              >
                <span className="text-[1.5rem] font-light"> sh ki Baat</span>
                {/* <span className="text-xs text-black font-normal"> */}
            ...
            <p className="text-slate-600">
              ...
              solutions to help you get an office space faster and cheaper
            </p>
          </div>
