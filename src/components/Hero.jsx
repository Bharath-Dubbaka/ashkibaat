   ...
   return (
      <div className="relative w-full overflow-hidden">
         ...
         <div className="relative w-full h-[500px] md:h-[600px] ">
            ...
            {/* White diagonal overlay (desktop only) */}
         ...
         <div className="absolute top-0 left-0 w-full md:w-7/12 lg:w-5/12 p-6 md:p-12 z-20 ">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-100 md:text-teal-900 mb-6">
               Ash Ki Baat: Cricket, Conversations & Beyond!
            </h1>

            <p className="text-base md:text-lg text-gray-100 md:text-gray-700 mb-6">
            ...
            <div className="flex items-center text-sm text-gray-800 md:text-gray-500 mt-2 bg-slate-200 md:bg-none rounded-lg p-5 md:p-4">
