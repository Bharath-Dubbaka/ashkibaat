      ...
      <div className="min-h-screen w-full rounded-md bg-neutral-50 relative flex flex-col items-center justify-center antialiased dotted-pattern">
         <div className="max-w-2xl mx-auto p-4">
            ...
            <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center relative z-10">
               Exciting things are happening! Our team is expanding and hard at
               work preparing engaging podcasts for you. Stay tuned for
               insightful discussions and expert interviews. We're committed to
               bringing you valuable content as soon as it's ready!
            </p>
            <input
               type="text"
